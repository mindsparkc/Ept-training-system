...
import com.sinosoft.common.utils.ip.AddressUtils;
...
public class TokenService
{
    ...
    private static final Long MILLIS_MINUTE_24H = 24 * 60 * 60 * 1000L;
    ...
    public void verifyToken(LoginUser loginUser) {
        ...
        // 刷新 Token（当还有 24 小时过期，则延长 token 有效期）
        if (expireTime - currentTime <= MILLIS_MINUTE_24H) {
            refreshToken(loginUser);
        }
    }
