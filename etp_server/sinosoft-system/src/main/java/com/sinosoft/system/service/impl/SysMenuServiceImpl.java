...
import com.sinosoft.common.core.domain.TreeSelect;
...
import com.sinosoft.system.domain.vo.MetaVo;
import com.sinosoft.system.domain.vo.RouterVo;
import com.sinosoft.system.mapper.SysMenuMapper;
import com.sinosoft.system.mapper.SysRoleMapper;
import com.sinosoft.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
     ...
     */
    @Override
    public List<SysMenu> selectMenuTreeByUserId(Long userId,String plateform)
    {
        List<SysMenu> menus = null;
        if (SecurityUtils.isAdmin(userId))
        {
            menus = menuMapper.selectMenuTreeAll(plateform);
        }
        else
        {
            menus = menuMapper.selectMenuTreeByUserId(userId,plateform);
        }
