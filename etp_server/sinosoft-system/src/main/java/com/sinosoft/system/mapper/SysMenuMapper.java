...
public interface SysMenuMapper
{
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenuTreeAll(@Param("platform") String platform);
     ...
     * @return 菜单列表
     */
    public List<SysMenu> selectMenuTreeByUserId(@Param("userId") Long userId,@Param("platform")String platform);
