package com.sinosoft.admin.curriculum.controller;
 ...
 */
@RestController
@RequestMapping("/admin/v1/curriculum/category")
public class CurriculumCategoryController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('curriculum:category:list')")
     ...
     * 获取课程分类详细信息
     */
    @PreAuthorize("@ss.hasPermi('curriculum:category:query')")
     ...
     * 新增课程分类
     */
    @PreAuthorize("@ss.hasPermi('curriculum:category:add')")
     ...
     * 修改课程分类
     */
    @PreAuthorize("@ss.hasPermi('curriculum:category:edit')")
     ...
     * 删除课程分类
     */
    @PreAuthorize("@ss.hasPermi('curriculum:category:remove')")
