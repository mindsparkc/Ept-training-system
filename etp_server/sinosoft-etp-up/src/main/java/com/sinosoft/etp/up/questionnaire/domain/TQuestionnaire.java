...
public class TQuestionnaire extends BaseEntity
{
    ...
    public void setXyid(Long xyid){this.xyid = xyid;}

    public Long getxyid(){
        return xyid;
    }

    public void setWjnr(String wjnr) {this.wjnr = wjnr;}

    public String getWjnr(){return wjnr;}

    public void setWjStatus(String wjStatus) {this.wjStatus = wjStatus;}

    public String getWjStatus() {return wjStatus;}
