package com.sinosoft.etp.cp.tag.controller;
 ...
 */
@RestController
@RequestMapping("/etp/tagWithCp")
public class TTagWithCpController extends BaseController
{
    @Autowired
    private ITTagWithCpService tTagService;
