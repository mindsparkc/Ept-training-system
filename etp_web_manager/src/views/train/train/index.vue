    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24" class="span20-right">
        ...
        <el-table v-loading="loading" :data="paperList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="习题集状态" align="center" prop="status" >
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      if(!row.paperId){
        ...
        let info = {"习题集名称":row.name,"创建时间":row.createTime}
        this.delInfo = info
      }
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有习题集基础信息数据项?', "警告", {
    ...
    handleFb(row,status){
      ...
      this.$confirm('是否确认'+label+'习题集?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(() => {
