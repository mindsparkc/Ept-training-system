    ...
    <el-dialog :title="title"
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户组名" prop="groupName">
          <el-input v-model="form.groupName" placeholder="请输入用户组名" />
        </el-form-item>
      </el-form>
...
<script>
import { listGroup, getGroup, delGroup, addGroup, updateGroup, exportGroup } from "@/api/system/userGroup";
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          this.$confirm('请确认是否保存当前用户组信息?', '提示', {
