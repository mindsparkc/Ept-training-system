          ...
          <el-col :span="4" style="text-align: center">
            <el-image
              style="
                ...
                margin-top: 15px;
              "
              :src="curriculum.fmt==null?require('@/assets/images/cover.jpg'):curriculum.fmt"
              fit="cover"
            />
          </el-col>
...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      // this.$router.push({path: "/etp/curriculumresource/index", query: {t: Date.now()}});
      this.$router.go(-1)
    },
    /** 搜索过滤*/
